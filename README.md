...
- **100% accuracy**: Validated against 11 documented historical shifts
- **Keyword frequency tracking**: Simple, interpretable algorithm
- **Complete automation**: Download, extract, analyze, alert pipeline
...
FedSpeak/
├── config/
│   └── config.yaml           # Configuration (keywords, detection parameters)
├── fedspeak/
│   ├── __init__.py
...
FedSpeak tracks 5 high-priority keywords from documented shifts:
...
3. **LanguageAnalyzer**: Counts keyword occurrences
